# Squirrel
- Binary classification of "SHIFT": achieved 75% ROC-AUC (+15% vs baseline RF)
...
- Solutions: normalisation, regularisation, retraining, detection, regime switching, online adaptation, etc
